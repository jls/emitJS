...
(function(global){
  ...
  // Create our namespace and add it to the global object.
  ...
  emitterNS.EventListener = function(type, listener, scope, once, removeCallback){
    ...
    // Flag indicating whether the listener should
    // only ever fire once.
    // @type boolean
  ...
  //
  // Object representing a binding between an event and multiple listeners.
  // @constructor
  //
